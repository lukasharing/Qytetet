...
(defmodule Recomendador_Rama)
    ...
    (defrule MuchosAniosCursados
                ...
                (test (> ?Anios 5))
            =>
                ; Explicamos por que eliminamos las ramas.
                (printout t "No se recomienda la rama IC ni CSI ya que son ramas con alta dificultad y puede requerir además varios anos." crlf)
    ...
    (defrule Analiza_Nota
        ...
        => 
            ...
            (if (<= ?Nota_Num 5) then
                ...
                (printout t "No se le recomienda CSI si tiene una nota baja, puede serle más complejo." crlf)
                (assert (EliminaRama Computacion_y_Sistemas_Inteligentes))
                (assert (EliminaRama Ingenieria_de_Computadores))
    ...
    (defrule Pide_Gustos
        ...
        =>
            ...
            (if (= (str-compare ?text_interes "hardware") 0) then
                (assert (Interes Hardware))
                (printout t "Te gusta 'cacharrear', has elegido Hardware!" crlf)
            else (= (str-compare ?text_interes "software") 0) then
    ...
    (defrule Pide_Matematicas
        ...
        =>
            ...
            (if (= (str-compare ?r "si") 0) then
                (assert (Gustar_Matematicas Si))
            else (if (= (str-compare ?r "no") 0) then
    ...
    (defrule Interesa_Software
        ...
        =>
            ...
            (printout t "No se recomienda ni IC ni TI ya que esta mas orientada para el hardware, las descarto." crlf)
            (assert (EliminaRama Ingenieria_de_Computadores))
    ...
    (defrule Interesa_Software_Gusta_Matematicas
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "La rama de sistemas de informacion requiere poco conocimiento matematico, la descarto." crlf)
    ...
    (defrule Interesa_Software_Gusta_Matematicas_Docencia
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "La rama del software se aconseja mas para el ambito laboral externo a la universidad, por lo que lo descarto." crlf)
    ...
    (defrule Interesa_Software_Gusta_Matematicas_No_Docencia
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "La rama de sistemas de informacion requiere poco conocimiento matematico." crlf)
            (assert (EliminaRama Computacion_y_Sistemas_Inteligentes))
    )
    ...
    (defrule Interesa_Software_No_Gusta_Matematicas
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "Eliminamos la rama de CSI e IS ya que requieren alto conocimiento sobre las matemáticas y por ello, no se le recomienda." crlf)
            (assert (EliminaRama Computacion_y_Sistemas_Inteligentes))
            (assert (EliminaRama Ingenieria_del_Software))
    )
    ...
    (defrule Interesa_Hardware
        ...
        => 
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "La computacion y sistema inteligentes e IS requieren de interes sobre el software, por lo que se descartan." crlf)
            (assert (EliminaRama Computacion_y_Sistemas_Inteligentes))
            (assert (EliminaRama Ingenieria_del_Software))
    ...
    (defrule Interesa_Hardware_Programar_Poco
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "La rama TIC y SI requieren de gustar programar medio, por lo que se descartan." crlf)
            (assert (EliminaRama Tecnologias_de_la_Informacion))
            (assert (EliminaRama Sistemas_de_Informacion))
    )
    ...
    (defrule Interesa_Hardware_Programar_Mas_Poco
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "Si te gusta poco programar, eliminamos la rama de Computadores ya que no es de interes. " crlf)
            (assert (EliminaRama Ingenieria_de_Computadores))
            ; Preguntamos por las Matemáticas
            (assert (Pedir_Informacion Matematicas))
    )
    ...
    (defrule Interesa_Hardware_Programar_Mas_Poco_No_Matematicas
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "Si no te gusta las matematicas, no se recomienda la rama TIC ya que hay con diferencia a las demás." crlf)
            (assert (EliminaRama Tecnologias_de_la_Informacion))
    )
    ...
    (defrule Interesa_Hardware_Programar_Mas_Poco_Si_Matematicas
        ...
        =>
            ; Quitamos aquellas ramas que no podemos recomendar
            (printout t "Si te gustan las matematicas, no se recomienda Sistemas de Información ya que hay pocas matemáticas." crlf)
            (assert (EliminaRama Sistemas_de_Informacion))
    )
    ...
    (defrule Recomienda_Computacion_y_Sistemas_Inteligentes
        ...
        =>
            (assert (Consejo Computacion_y_Sistemas_Inteligentes "Te gusta la docencia y las matemáticas, además del Software."))
            (retract ?r)
            (retract ?p)
    )
    ...
    (defrule Recomienda_Ingenieria_del_Software
        ...
        =>
            (assert (Consejo Ingenieria_del_Software "El Software te apasiona, las matemáticas te gusta, pero no la docencia."))
            (retract ?r)
            (retract ?p)
    )
    ...
    (defrule Recomienda_Ingenieria_de_Computadores
        ...
        =>
            (assert (Consejo Ingenieria_de_Computadores "Te apasiona el Hardware, por lo que no te gusta programar."))
            (retract ?r)
            (retract ?p)
    )
    ...
    (defrule Recomienda_Sistemas_de_Informacion
        ...
        =>
            (assert (Consejo Sistemas_de_Informacion "Te gusta el Software y el Hardware, te gusta trabajar para ti o una empresa, programar no te disgusta."))
            (retract ?r)
            (retract ?p)
    )
    ...
    (defrule Recomienda_Tecnologias_de_la_Informacion
        ...
        =>
            (assert (Consejo Tecnologias_de_la_Informacion "Te gusta el hardware y programar también."))
            (retract ?r)
            (retract ?p)
    )
